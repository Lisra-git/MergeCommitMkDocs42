...
print(timeit.timeit("racine(8371779, p_mid)", globals=globals(), number=1)/1)
print(timeit.timeit("racine(8371779, p_mid, 20)", globals=globals(), number=1)/1)
print(timeit.timeit("racine(8371779, p_hard, 20)", globals=globals(), number=1)/1)
